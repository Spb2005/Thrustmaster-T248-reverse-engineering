...
#line 1 "..\\lcd_driver\\VK2C23B_IO_I2C_QUASI.h"
...
#line 20 "..\\lcd_driver\\VK2C23B_IO_I2C_QUASI.h"
...
#line 48 "..\\lcd_driver\\VK2C23B_IO_I2C_QUASI.h"
	
#line 65 "..\\lcd_driver\\VK2C23B_IO_I2C_QUASI.h"
	
#line 83 "..\\lcd_driver\\VK2C23B_IO_I2C_QUASI.h"
...
#line 15 "..\\lcd_driver\\VK2C23B_IO_I2C_QUASI.c"
...
unsigned char VK2C23B_segtab[35]={
	4,5,6,7,8,9,										
...
unsigned char VK2C23B_dispram[35];



unsigned char VK2C23B_segi,VK2C23B_comi;
unsigned char VK2C23B_maxcom;
...
unsigned char WriteCmdVK2C23B(unsigned char cmd, unsigned char data )
{
	...
	VK2C23B_I2CWriteByte( 0x7c|0x00 );
...
void VK2C23B_DisAll(unsigned char dat)
{
	...
	WritenDataVK2C23B(0,VK2C23B_dispram,35);
}
...
{	
	...
	WriteCmdVK2C23B(0x82,0x02); 

	VK2C23B_maxcom=8;
	WriteCmdVK2C23B(0x84,0x03); 		
	WriteCmdVK2C23B(0x86,0x00); 	

	WriteCmdVK2C23B(0x88,0x00); 		
...
{	
	...
	while(1)
	{
		...
		VK2C23B_DisAll(0xAA);			
		ReadnDataVK2C23B(0,VK2C23B_readbuf,35);	
		delay_nms(1500);					
		VK2C23B_DisAll(0x55);			
		ReadnDataVK2C23B(0,VK2C23B_readbuf,35);	
		delay_nms(1500);					
		...
		VK2C23B_DisAll(0x00);			
		delay_nms(500);					  
		for(VK2C23B_segi=0;VK2C23B_segi<35;VK2C23B_segi++)
		{
			for(VK2C23B_comi=0;VK2C23B_comi<VK2C23B_maxcom;VK2C23B_comi++)
			{
					VK2C23B_DisDotOn(VK2C23B_segtab[VK2C23B_segi]-4,VK2C23B_comi);	
				delay_nms(300);				
				VK2C23B_DisDotOff(VK2C23B_segtab[VK2C23B_segi]-4,VK2C23B_comi);	  
			}
		}
