/**
  ...
  * @version V1.2
  * @date    05-17-2020
  * @brief   Header files for VK2C23B
  ******************************************************************************
  * @attention
  ******************************************************************************
  */
...
//驱动seg数
//8com
#define 	VK2C23B_SEGNUM					35

//以下管脚配置根据客户单片机做相应的修改 
#define VK2C23B_SCL_PIN    BIT15
#define VK2C23B_SCL_PORT   PB
#define VK2C23B_SCL_IO     PB15

#define VK2C23B_SDA_PIN    BIT5
#define VK2C23B_SDA_PORT   PB
#define VK2C23B_SDA_IO     PB5

//以下管脚输出定义根据客户单片机做相应的修改   
#define VK2C23B_SCL_H() 				VK2C23B_SCL_IO = 1 
#define VK2C23B_SCL_L() 				VK2C23B_SCL_IO = 0 

#define VK2C23B_SDA_H() 				VK2C23B_SDA_IO = 1 
#define VK2C23B_SDA_L() 				VK2C23B_SDA_IO = 0 

#define VK2C23B_GET_SDA() 			VK2C23B_SDA_IO
#define VK2C23B_SET_SDA_IN() 	{\
	GPIO_SetMode(VK2C23B_SDA_PORT, VK2C23B_SDA_PIN, GPIO_MODE_INPUT);\
}
//SDA脚设为输出脚，用于发送命令和写显示RAM数据
#define VK2C23B_SET_SDA_OUT() 	{\
	GPIO_SetMode(VK2C23B_SDA_PORT, VK2C23B_SDA_PIN, GPIO_MODE_OUTPUT);\
}
/* Exported functions ------------------------------------------------------- */
void VK2C23B_Init(void);
void VK2C23B_DisAll(unsigned char dat);
void VK2C23B_DisSegComOn(unsigned char seg,unsigned char com);
void VK2C23B_DisSegComOff(unsigned char seg,unsigned char com);
